    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="<?=base_url('dashboard')?>" class="navbar-brand"><b>ANGKASA</b></a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li <?=$this->uri->segment(1) == ''  ?'class="active"':''?>>
              <a href="<?=site_url('transaksi')?>">
                <i class="fa fa-shopping-cart"></i> <span>&nbspTransaksi</span>
              </a>
            </li>
            <li <?=$this->uri->segment(1) == 'stock'  ?'class="active"':''?>>
              <a href="<?=site_url('stock')?>">
                <i class="fa fa-folder"></i> <span>&nbspStock Barang</span>
              </a>
            </li>
            <li <?=$this->uri->segment(1) == ''  ?'class="active"':''?>>
